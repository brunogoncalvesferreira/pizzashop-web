...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 89898989</DialogTitle>
      ...
      <div className="space-y-6">
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">3289897878</TableCell>
            </TableRow>

            <TableRow>
              <TableCell className="text-muted-foreground">E-mail</TableCell>
              <TableCell className="flex justify-end">
                brunogonferreira@gmail.com
              </TableCell>
            </TableRow>
        ...
        <Table>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableHead>Pizza Mussarela</TableHead>
              <TableHead className="text-right">2</TableHead>
